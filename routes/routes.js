...
export default (app) => {
    ...
    app.route("/user").post(userController.login);
    ...
    app.route("/subscribe").post(subscribeController.createSubscriber);
    app.route("/subscribe").get(subscribeController.getSubscribers);
